...
bl100 = propar.instrument("/dev/ttyUSB2", 7)
diffp = propar.instrument("/dev/ttyUSB2", 4)
coriflow = propar.instrument("/dev/ttyUSB2", 5)
...
path="/home/flow-setup/Desktop/Data/" 		#This is the path where the csv file and graphs will be written to.
